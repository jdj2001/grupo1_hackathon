...
<div class="container mx-auto mt-10">
    ...
    <a href="{{ route('video-consultas.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 inline-block">Nueva Video Consulta</a>
